...
android {
    ...
    namespace = "com.composenhilt"

    defaultConfig {
        applicationId = "com.composenhilt"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
val material3DesignVersion by extra("1.3.1")
...
dependencies {
    ...
    implementation("androidx.compose.material3:material3:$material3DesignVersion")
    //Hilt
